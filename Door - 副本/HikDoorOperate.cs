...
namespace HikDeviceApi.Door
{
    ...
    public class HikDoorOperate
    {
        ...
        /// 设备参数
        /// </summary>
        public HikDeviceApi.Door.HikDoorStruct.NET_DVR_DEVICECFG_V40 deviceCfg;//设备参数
        ///// <summary>
        ///// 登录用户信息V40
        ///// </summary>
        ...
        /// 登录设备V30
        /// </summary>
        public HikDoorStruct.NET_DVR_DEVICEINFO_V30 deviceInfoV30;
        /// <summary>
        /// 登录设备V40
        /// </summary>
        ...
        /// 时间信息
        /// </summary>
        public HikDoorStruct.NET_DVR_TIME deviceTime;//时间信息
        /// <summary>
        /// 门参数
        /// </summary>
        ...
        /// 登录状态回调
        /// </summary>
        public event HikDeviceApi.Door.HikDoorDelegate.fLoginResultCallBack LoginResult;
        /// <summary>
        /// 监听回调
        /// </summary>
        public event HikDeviceApi.Door.HikDoorDelegate.MSGCallBackV31 ListenResult;
        /// <summary>
        /// 接收异常消息的回调函数，回调当前异常的相关信息
        /// </summary>
        public event HikDeviceApi.Door.HikDoorDelegate.fExceptionCallBack ExceptionCallBack;
        /// <summary>
        /// 远程配置回调函数
        /// </summary>
        event HikDeviceApi.Door.HikDoorDelegate.fRemoteConfigCallback RemoteConfigCallback;
        ...
        public bool LoginV30(ref UseInfo info, bool isReConnect = true)
        {
            try
            {
                ...
                //deviceIp = ipAddress;
                //devicePoint = port;
                info.UserId = HikDeviceApi.Door.HikDoorApi.NET_DVR_Login_V30(info.LoginDeviceIp, info.LoginDevicePoint, info.LoginUserName, info.LoginUserPwd, ref deviceInfoV30);
                ...
                else
                {
                    if (isReConnect)
                    {
                        HikDeviceApi.Door.HikDoorApi.NET_DVR_SetConnectTime(info.WaitTime, info.TryTimes);
                        HikDeviceApi.Door.HikDoorApi.NET_DVR_SetReconnect(info.Interval, info.EnableRecon);
                    }
        ...
        {
            bool b= HikDeviceApi.Door.HikDoorApi.NET_DVR_Logout(info.UserId);
            if(b)
                info.UserId = -1;
            return b;
        }
        ...
        public bool SetExceptionCallBack_V30(int nMessage, IntPtr hWnd, IntPtr pUser)
        {
            if (ExceptionCallBack == null)
                return false;
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetExceptionCallBack_V30(nMessage, hWnd, ExceptionCallBack, pUser);
        }
        #endregion
        ...
        public bool SetDVRMessageCallBack_V31()
        {
            if (ListenResult == null)
                return false;
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetDVRMessageCallBack_V31(ListenResult, IntPtr.Zero);
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetRecvTimeOut(nRecvTimeOut);
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_GetLastError();
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetDVRConfig(userId, dwCommand, lChannel, lpInBuffer, dwInBufferSize);
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(userId, dwCommand, lChannel, lpOutBuffer, dwOutBufferSize, ref lpBytesReturned);
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetConnectTime(dwWaitTime, dwTryTimes);
        }
        /// <summary>
        /// 设置重连时间
        /// </summary>
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetReconnect(dwInterval, bEnableRecon);
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_Init();
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_Cleanup();
        }
        #endregion
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_ControlGateway(info.UserId, doorNo, (uint)con);
        }
        ...
        public bool GetDeviceWorkStatus(UseInfo info, ref string doorStatus, ref string lockStatus)
        {
            ...
            uint dwReturn = 0;
            bool b = HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_GET_ACS_WORK_STATUS, 0, deviceInfo, dwSize, ref dwReturn);
            string ds = "";
            string ls = "";
            if (b)
            {
        ...
        public bool StartWatchDoorV30(ref UseInfo info)
        {
            ...
            HikDeviceApi.Door.HikDoorStruct.NET_DVR_SETUPALARM_PARAM struAlarmParam = new HikDeviceApi.Door.HikDoorStruct.NET_DVR_SETUPALARM_PARAM();
            struAlarmParam.dwSize = (uint)Marshal.SizeOf(struAlarmParam);
            struAlarmParam.byAlarmInfoType = 1;//1智能交通设备有效
            info.AlarmId = HikDeviceApi.Door.HikDoorApi.NET_DVR_SetupAlarmChan_V30(info.UserId);
        ...
        public bool StartListenV30(ref int listenId, string localhostIP,int listenPort=7200)
        {
            ...
            struAlarmParam.dwSize = (uint)Marshal.SizeOf(struAlarmParam);
            struAlarmParam.byAlarmInfoType = 1;//1智能交通设备有效
            listenId = HikDeviceApi.Door.HikDoorApi.NET_DVR_StartListen_V30(localhostIP, (short)listenPort, ListenResult, IntPtr.Zero);
            if (listenId == -1)
            {
                //int x = GetlastErrorNo();
                return false;
        ...
        public bool EndWatchDoorV30(ref UseInfo info)
        {
            try
            {
                bool b=HikDeviceApi.Door.HikDoorApi.NET_DVR_CloseAlarmChan_V30(info.AlarmId);
                if (b)
                {
                    info.AlarmId = -1;
                    ListenResult = null;
        ...
        public bool StopListenV30(ref int listenId)
        {
            try
            {
                bool b=HikDeviceApi.Door.HikDoorApi.NET_DVR_StopListen_V30(listenId);
                if (b)
                {
                    listenId = -1;
                    ListenResult = null;
        ...
        public bool GetDoorInfo(UseInfo info, int chanel)
        {
            ...
            uint dwReturn = 0;
            bool b = HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_GET_DOOR_CFG, chanel, ptrIpParaCfgV40, dwSize, ref dwReturn);
            if (b)
            {
        ...
        public string GetDeviceTime(UseInfo info)
        {
            ...
            uint dwReturn = 0;
            bool b = HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_GET_TIMECFG, 0, ptrIpParaCfgV40, dwSize, ref dwReturn);
            if (b)
            {
                deviceTime = (HikDeviceApi.Door.HikDoorStruct.NET_DVR_TIME)Marshal.PtrToStructure(ptrIpParaCfgV40, typeof(HikDeviceApi.Door.HikDoorStruct.NET_DVR_TIME));
        ...
        public bool SetDeviceDate(UseInfo info, DateTime time)
        {
            ...
            IntPtr ptrIpParaCfgV40 = Marshal.AllocHGlobal((Int32)dwSize);
            Marshal.StructureToPtr(deviceTime, ptrIpParaCfgV40, false);
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_SET_TIMECFG, 0, ptrIpParaCfgV40, dwSize);
        }
        #endregion
        ...
        public string GetDeviceInfo(UseInfo info)
        {
            ...
            uint dwReturn = 0;
            bool b = HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_GET_DEVICECFG_V40, 0, deviceInfo, dwSize, ref dwReturn);
            if (b)
            {
                deviceCfg = (HikDeviceApi.Door.HikDoorStruct.NET_DVR_DEVICECFG_V40)Marshal.PtrToStructure(deviceInfo, typeof(HikDeviceApi.Door.HikDoorStruct.NET_DVR_DEVICECFG_V40));
        ...
        {
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_RebootDVR(info.UserId);
        }
        #endregion
        ...
        public bool SetCardConfig(UseInfo info, string cardNo, string cardPassWord, DateTime startDate, DateTime endDate, bool cardValid = true, HikDeviceApi.Door.HikDoorEnum.CardType cardType = HikDeviceApi.Door.HikDoorEnum.CardType.普通卡, bool struValid = true, bool leaderCard = false)
        {
            ...
            cardConfig.struValid.struBeginTime = new HikDeviceApi.Door.HikDoorStruct.NET_DVR_TIME_EX() { wYear = (ushort)startDate.Year, byMonth = byte.Parse(startDate.Month.ToString()), byDay = byte.Parse(startDate.Day.ToString()), byHour = byte.Parse(startDate.Hour.ToString()), byMinute = byte.Parse(startDate.Minute.ToString()), bySecond = byte.Parse(startDate.Second.ToString()) };
            cardConfig.struValid.struEndTime = new HikDeviceApi.Door.HikDoorStruct.NET_DVR_TIME_EX() { wYear = (ushort)endDate.Year, byMonth = byte.Parse(endDate.Month.ToString()), byDay = byte.Parse(endDate.Day.ToString()), byHour = byte.Parse(endDate.Hour.ToString()), byMinute = byte.Parse(endDate.Minute.ToString()), bySecond = byte.Parse(endDate.Second.ToString()) };
            byte[] byRes = Encoding.UTF8.GetBytes("0");
        ...
        public bool GetCardReaderInfo(UseInfo info, int deviceNo, out HikDeviceApi.Door.HikDoorStruct.NET_DVR_CARD_READER_CFG config)
        {
            ...
            uint dwReturn = 0;
            bool b = HikDeviceApi.Door.HikDoorApi.NET_DVR_GetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_GET_CARD_READER_CFG, deviceNo, deviceInfo, dwSize, ref dwReturn);
            if (b)
            {
        ...
        public bool SetCardReaderInfo(UseInfo info, int deviceNo, HikDeviceApi.Door.HikDoorEnum.CardReaderType type, bool enableFailAlarm = true, bool enableTamperCheck = true, int maxReadCardFailNum = 5, int offlineCheckTime = 5, int pressTimeout = 5, int swipeInterval = 0, int errorLedPolarity = 1, int okLedPolarity = 1)
        {
            ...
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_SET_CARD_READER_CFG, deviceNo, ptrTimeCfg, (uint)nSize);
        ...
        public bool SetDoorInfo(UseInfo info, int doorNo, string doorName, int stressPassword, int supperPassword, bool isEnableDoorLock = true, bool isEnableLeaderCard = false, bool isOpenButton = false, bool isOpenMagnetic = false, int alarmTimeout = 10, int openTime = 9, int disabledOpenTime = 20, int leaderCardOpenTime = 30)
        {
            ...
            return HikDeviceApi.Door.HikDoorApi.NET_DVR_SetDVRConfig(info.UserId, (uint)HikDeviceApi.Door.HikDoorEnum.DwCommand.NET_DVR_SET_DOOR_CFG, doorNo, ptrTimeCfg, (uint)nSize);
